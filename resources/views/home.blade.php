...
<body>
        ...
        <div class="row">
                ...
                <div class="product-card">
                    <div class="product-icons">
                        <a onclick="addToCart({{$produk->id}}, '{{$produk->namaproduk}}', {{$produk->harga}}, '{{Storage::url($produk->image)}}')">
                        ...
                        <a onclick="setModalContent({{$produk->id}},'{{$produk->namaproduk}}', '{{$produk->deskripsi}}', {{$produk->harga}}, '{{Storage::url($produk->image)}}')" class="item-detail-button"><svg xmlns="http://www.w3.org/2000/svg" width="24"
    ...
    <div class="modal" id="item-detail-modal">
        <div class="modal-container">
            ...
            <div class="modal-content">
                <img src="{{asset('img/product/1.jpg')}}" id="modal-product-image" alt="Product 1">
                <div class="product-content">
                    <h3 id="modal-product-name">Product 1</h3>
                    <p id="modal-product-desc">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Provident, tenetur cupiditate facilis
                        obcaecati
    ...
    <script>
        function setModalContent(id, name, desc, price, image) {
            document.querySelector('#modal-product-name').innerHTML = name;
            document.querySelector('#modal-product-price').innerHTML = rupiah(price);
            document.querySelector('#modal-product-desc').innerHTML = desc;
            ...
            modalAddToCart.addEventListener('click', addTocartEvent);
